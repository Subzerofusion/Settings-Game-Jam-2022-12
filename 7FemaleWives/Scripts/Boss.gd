...
func _physics_process(delta):
	...
	#	Ship.move_and_slide(desired_ship_direction)
		...
		if ($Ship.position - player_position).length() < activation_radius:
...
func _on_Area2D_area_entered(area):
	...
	if area.name == "SwordArea":
		health -= 1
		if health == 4:
			$Ship/Hull.texture = load("res://Sprites/Enemy/Boss/Boss2.png")
			$Sail.texture = load("res://Sprites/Enemy/Boss/BossSail2.png")
			play_sound("hurt")
		if health == 3:
			$Ship/Hull.texture = load("res://Sprites/Enemy/Boss/Boss3.png")
			$Sail.texture = load("res://Sprites/Enemy/Boss/BossSail3.png")
			play_sound("hurt")
		if health == 2:
			$Ship/Hull.texture = load("res://Sprites/Enemy/Boss/Boss4.png")
			$Sail.texture = load("res://Sprites/Enemy/Boss/BossSail4.png")
			play_sound("hurt")
		elif health == 1:
			$Ship/Hull.texture = load("res://Sprites/Enemy/Boss/Boss5.png")
			$Sail.texture = load("res://Sprites/Enemy/Boss/BossSail5.png")
			play_sound("hurt")
		elif health == 0:
			$Ship/Hull.texture = load("res://Sprites/Enemy/Boss/Boss6.png")
			$Sail.texture = load("res://Sprites/Enemy/Boss/BossSail6.png")
			play_sound("dead")
			alive = false
			dying = true
